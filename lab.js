...
if (amysAge < brittanisAge) {
  ...
  console.log(" They are the same age or this program is broken")
}
...
if (temperature >= 80 && rain === true ) {
  console.log("One should wear a t-shirt and take an umbrella since it is raining")
} else if (temperature >= 80 && rain === false ) {
  console.log("Sunny hot days are great for shorts, t-shirts and sunglasses.")
} else if (temperature > 60 && temperature < 80 && rain === true ) {
  console.log("One should wear a rain-jacket since it is raining")
} else if (temperature > 60 && temperature < 80 && rain === false ) {
  console.log("A light jacket would be best today")
} else if (temperature <= 60 && rain === true ) {
  console.log("One should wear a jacket and carry an umbrella.")
} else {
  console.log("Put on some sneakers and go run a mountain, you will warm up.")
}
